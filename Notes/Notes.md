...
- **Question:**
  - how Micro Services can generate a page that would use the same style of the host application?
    
## 2025-09-16

__Topic: Software Architecture Styles:__

- We talked about monolithic and distributed architectures
- We weatched a [video](https://developertoarchitect.com/lessons/lesson159.html) about modular monolith
- Next week we will continue with watching videos on layered and microkernel architectures to complete monolithic styles
...
### Guest Recap
- Good insight into what was available 
- Crowd interest was good

- Potential Service Mesh review 

### Strangler Pattern 
- https://www.youtube.com/watch?v=DpuQ3-7e-rY

### Potential next guests
- CMDB Team (Heather Carter?)
...
- Cloud Engineering and DevSecOps (OpenShift/GitLab) teams both confirmed speakers 
 ...
 - DevSecOps - Paul Badcock
- We talked about the guest speaker series
 - The audience 
 - Potential Topics to be discussed by presenter (To be shared with presenter) 
 - Sample 'Filler' questions (To be shared with presenter and to be used if no other questions are asked) 
- Tasks 
 - Andrew to Draft Email to team managers 
 - Saeed to arrange timing with first speaker Paul Badcock 
